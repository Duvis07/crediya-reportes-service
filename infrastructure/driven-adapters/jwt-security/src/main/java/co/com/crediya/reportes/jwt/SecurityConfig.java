    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(org.springframework.http.HttpMethod.POST, "/api/v1/reportes/send-now").permitAll()
                        .pathMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/reportes").hasRole("ADMIN")
